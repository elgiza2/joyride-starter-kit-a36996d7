    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {schema.sender?.address ? (
          <Text style={styles.senderLine}>{schema.sender.address}</Text>
        ) : null}
        ...
        {schema.recipient?.name ? (
          <Text style={styles.recipient}>{schema.recipient.name}</Text>
        ) : null}
        {schema.recipient?.address ? (
          <Text style={styles.recipientLine}>{schema.recipient.address}</Text>
        ) : null}
