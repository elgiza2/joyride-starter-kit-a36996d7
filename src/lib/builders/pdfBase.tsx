...
try {
  Font.register({
    ...
    fonts: [
      ...
      {
        src: "https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2JL7SUc.ttf",
        fontWeight: 700,
      },
    ],
  });
...
// Register an Arabic-capable font so non-Latin scripts render instead of producing blank pages.
try {
  Font.register({
    family: "NotoArabic",
    fonts: [
      ...
      {
        src: "https://fonts.gstatic.com/s/notonaskharabic/v33/RrQ5bpV-9Dd1b1OAGA6M9PkyDuVBePeKNaxcsss0Y7bwvc5krK0zw_QnvA.ttf",
        fontWeight: 700,
      },
    ],
  });
...
export const hasArabic = (s?: string | null) => !!s && ARABIC_RE.test(s);
export const pickFont = (s?: string | null) => (hasArabic(s) ? "NotoArabic" : "Helvetica");
