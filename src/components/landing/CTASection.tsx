...
const CTASection = () => {
  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-48">
      <div className="absolute inset-0 bg-gradient-to-b from-purple-600/10 via-transparent to-transparent bg-pink-900" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
        <motion.h2
          ...
          className="font-display text-[10vw] font-black uppercase leading-[0.85] tracking-tighter text-foreground md:text-[8vw]"
        >
          {cta.line1}
        </motion.h2>
        <motion.h2
        ...
        <motion.p
          ...
          className="mx-auto mt-5 max-w-2xl text-base text-foreground/85 md:mt-8 md:text-2xl"
        >
          {cta.subtitle}
        </motion.p>
        ...
        >
          <FancyButton
            ...
            className="px-8 py-4 text-base md:px-12 md:py-5 md:text-lg"
          >
            {cta.button}
          </FancyButton>
        </motion.div>
