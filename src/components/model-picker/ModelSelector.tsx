...
const CHAT_MODELS: ModelOption[] = [
  { id: "qwen-max", name: `${MEGSY_CHAT_MODEL_LABEL} Max`, credits: "" },
  { id: "qwen-plus", name: `${MEGSY_CHAT_MODEL_LABEL} Plus`, credits: "" },
  { id: "qwen-turbo", name: `${MEGSY_CHAT_MODEL_LABEL} Turbo`, credits: "" },
