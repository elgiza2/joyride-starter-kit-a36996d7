...
const EGYPT_ASSET_BASE = "/route-assets/egypt";
...
const megaProjects = [
  {
    ...
    image: `${EGYPT_ASSET_BASE}/new-capital.webp`,
  ...
  },
  {
    ...
    image: `${EGYPT_ASSET_BASE}/suez-canal.webp`,
  ...
  },
  {
    ...
    image: `${EGYPT_ASSET_BASE}/infrastructure.webp`,
  ...
  },
  {
    ...
    image: `${EGYPT_ASSET_BASE}/renewable-energy.webp`,
      ...
      <section className="relative min-h-[110vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img loading="eager" fetchPriority="high" decoding="async"
            src={`${EGYPT_ASSET_BASE}/pyramids-night.webp`}
            ...
            >
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5]">
                <img loading="lazy" decoding="async"
                  src={`${EGYPT_ASSET_BASE}/luxor.webp`}
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden aspect-square max-w-lg mx-auto">
                <img loading="lazy" decoding="async"
                  src={`${EGYPT_ASSET_BASE}/sisi.webp`}
            ...
            {[
              {
                ...
                image: `${EGYPT_ASSET_BASE}/pyramids-night.webp`,
              },
              {
                ...
                image: `${EGYPT_ASSET_BASE}/luxor.webp`,
              },
              {
                ...
                image: `${EGYPT_ASSET_BASE}/hero-bg.webp`,
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
